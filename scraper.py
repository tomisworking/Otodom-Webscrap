...
def scrape_otodom(pages=5):
    base_url = "https://www.otodom.pl/pl/wyniki/wynajem/mieszkanie/dolnoslaskie/wroclaw/wroclaw/wroclaw"
    headers = {
...
if __name__ == "__main__":
    # Testing limited to 3 pages
    scrape_otodom(pages=3)
